...
Start a new repository: <ol>
    <li> Create a remote repository and copy its SSH URL: <img src="./access_setting.png" alt="Screen caption of GitHub desktop to see how to access 'setting'."/></li>
...
Ref: https://docs.github.com/en/get-started/using-git/about-git